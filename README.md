# AfterVeil Legal Documents

This repository hosts the legal documents (Privacy Policy and Terms of Use) for **AfterVeil**, a detective game developed by **PiazSoftware**.

## 🌐 Live Site

The legal documents are published using GitHub Pages and can be accessed at:
...
For detailed instructions on setting up GitHub Pages for this repository, see the [GitHub Pages Setup Guide](Docs/GitHub-Pages-Setup-Guide.md).
...
Use these URLs in your game to link to the legal documents. The setup guide includes code examples for Unity, Unreal Engine, and Godot.

## 📝 License

© 2025 PiazSoftware. All rights reserved.

---

**Game**: AfterVeil  
**Developer**: PiazSoftware